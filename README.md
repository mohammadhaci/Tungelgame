...
لوحة سداسية فيها أوتاد، اشدّ خيطًا بين وتدين على خط مستقيم، وسكّر مثلثات لتجمع نقاطًا.
...
## 🌐 ملاحظة صريحة عن "الأونلاين"

اللعبة التي أرسلت صورها (وأغلب ألعاب هذا النوع) **لا تلعب ضد أشخاص حقيقيين** —
الخصوم بوتات بأسماء وأعلام عشوائية مع شاشة "بحث عن خصم" (جرّبها بوضع الطيران وستعمل!).
هذا المشروع يطبّق نفس الأسلوب: تجربة "أونلاين" كاملة بدون سيرفر، وبدون تكاليف شهرية.

إذا أردت لاحقًا لعبًا حقيقيًا بين لاعبين، الكود جاهز لذلك: استبدل
`src/services/opponents.ts` بخدمة matchmaking حقيقية (مثل Firebase أو WebSocket)
دون تغيير بقية اللعبة.
